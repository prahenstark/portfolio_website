...
import 'package:portfolio_demo1/models/header_items.dart';
...
List<HeaderItems> headerItems = [
  ...
  HeaderItems(title: "MY INTRO", onTap: () {}),
  HeaderItems(title: "SERVICES", onTap: () {}),
  HeaderItems(title: "PORTFOLIO", onTap: () {}),
  HeaderItems(title: "TESTIMONIALS", onTap: () {}),
  HeaderItems(title: "BLOGS", onTap: () {}),
  HeaderItems(
    title: "HIRE ME",
    onTap: () {},
    isButton: true,
